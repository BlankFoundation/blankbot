...
client.on("guildMemberUpdate", async (oldMember, newMember) => {
  ...
  if (
    ...
    channel.send(
      `Applicant ${newMember} has been promoted to Blank member! Welcome! Feel free to look around, ask questions in #◽〡no-silly-questions and browse the resources in #◽〡links!`
    );
  }
});
